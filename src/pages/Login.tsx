  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-2 sm:p-4 relative overflow-hidden bg-gradient-to-br from-slate-50 via-green-50/30 to-slate-100">
      ...
      <motion.div
        ...
        className="w-full max-w-xs xs:max-w-sm sm:max-w-md md:max-w-lg relative z-10"
      >
            ...
            <div className="p-4 xs:p-5 sm:p-6 md:p-8">
              ...
              >
                <div className="text-center">
                  <h2 className="text-lg xs:text-xl sm:text-2xl font-bold text-slate-800 mb-2 tracking-tight">
                    Connexion
                  </h2>
              ...
              <motion.div 
                ...
                className="mt-5 xs:mt-6 sm:mt-8 text-center"
              >
                <div className="relative">
                  ...
                  <div className="relative flex justify-center">
                    <span className="bg-white px-2 xs:px-3 sm:px-4 text-xs text-slate-500 uppercase tracking-wider font-medium">Nouveau ici ?</span>
                  </div>
                </div>
                <Link 
                  to="/signup" 
                  className="inline-flex items-center mt-2 xs:mt-3 sm:mt-4 text-green-600 hover:text-green-700 font-semibold text-xs xs:text-sm transition-all duration-200 hover:scale-105"
                >
                  <span>Créer un compte</span>
                  <ArrowRight size={12} className="xs:w-[14px] xs:h-[14px] ml-1 group-hover:translate-x-1 transition-transform duration-200" />
                </Link>
              </motion.div>
            </div>
          </div>
