        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              />
              <div className="absolute -bottom-6 -left-6 bg-green-600 p-6 rounded-2xl shadow-xl">
                <p className="text-white font-bold text-2xl">+7 ans</p>
                <p className="text-green-100">d'excellence</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600">Les principes qui guident tout ce que nous faisons</p>
          </motion.div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Nos Activités Principales</h2>
            <p className="text-xl text-gray-600">Solutions globales pour les entreprises africaines modernes</p>
          </motion.div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Équipe de Direction</h2>
            <p className="text-xl text-gray-600">Des leaders expérimentés qui font avancer notre vision</p>
          </motion.div>
            ...
            {team.map((member, index) => (
              ...
              >
                <div className="relative mb-6">
                  ...
                  />
                  <div className="absolute inset-0 w-32 h-32 rounded-full mx-auto bg-green-600 opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
                </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600">En collaboration avec des organisations de premier plan partout en Afrique</p>
          </motion.div>
            ...
            {partners.map((partner, index) => (
              ...
              >
                <img
                  src={partner.logo}
                  alt={partner.name}
                  className="w-24 h-24 object-contain rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300"
                />
              </motion.div>
            ))}
          </div>
