              ...
              <div className="absolute inset-0 flex items-center">
                <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 w-full">
                  <div className="max-w-xl md:max-w-2xl text-white">
                    ...
                    >
                      <span className="bg-green-600 px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-medium mb-3 sm:mb-4 inline-block">
                      ...
                      <div className="flex items-center space-x-3 sm:space-x-4">
                        ...
                        <button className="bg-white text-gray-900 px-4 sm:px-6 py-2.5 sm:py-3 rounded-full font-semibold hover:bg-gray-100 transition-colors duration-200 flex items-center space-x-2">
                          <span>Explore</span>
