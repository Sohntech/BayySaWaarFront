    ...
    <div className="max-w-5xl mx-auto">
      <div className="relative">
        <motion.div
          ...
          className="relative bg-gradient-to-br from-white to-gray-50 rounded-3xl shadow-xl p-12 border border-gray-100"
        >
          ...
          <blockquote className="text-2xl md:text-3xl text-gray-700 text-center leading-relaxed mb-10 italic font-light">
          ...
          >
            <div className="relative">
              <img
                ...
                className="w-24 h-24 rounded-full object-cover shadow-lg ring-4 ring-green-100"
              />
